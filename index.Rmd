...
workshop <- c('what is the problem? \n why should we care?','how hard can it be?','project planning', 'NA', 'why doesnt everyone do it?', 'flexibility week', 'NA', 'group presentations', 'best practices: reproducible research', 'best practices: workflow')
